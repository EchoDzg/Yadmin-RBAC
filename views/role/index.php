                    ...
                    <div class="layui-card">
                        <div class="layui-card-body reloadTable">
                                ...
                                <div class="layui-inline layui-show-xs-block">
                                    <input class="layui-input" name="name" id="tReload" autocomplete="off" placeholder="请输入角色名">
                                </div>
                                <div class="layui-inline layui-show-xs-block">
                        ...
                        <div class="layui-card-header">
                            <button class="layui-btn layui-btn-danger" id="auditBtn"><i class="layui-icon"></i>批量删除</button>
                            <button class="layui-btn" onclick="xadmin.open('添加角色','<?=UrlService::buildUrl('/role/set-roles') ?>',600,400)"><i class="layui-icon"></i>添加</button>
                        </div>
...
<script type="text/html" id="manageTpl">
    ...
    <a title="编辑" onclick="xadmin.open('编辑','/role/set-roles?id={{ d.id }}',600,400)" href="javascript:;">
                                      <i class="layui-icon"></i>
    </a>
